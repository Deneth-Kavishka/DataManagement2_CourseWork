                ...
                <div key={item.id} className="flex border-b border-neutral-200 pb-4 mb-4">
                  ...
                  <div className="ml-4 flex-1">
                    <div className="flex justify-between">
                      ...
                      <p className="text-sm font-medium text-primary">LKR{item.price.toFixed(2)}</p>
                    </div>
          ...
          {cartItems.length > 0 && (
            <div className="border-t p-4">
              ...
              <div className="flex justify-between mb-4">
                ...
                <span className="font-medium">LKR {(cartTotal * 0.01).toFixed(2)}</span>
              </div>
              <div className="flex justify-between mb-2">
                <span className="text-neutral-600"><i>Delivery costs are determined by your location</i></span>
                <span className="font-medium"></span>
              </div>
              <div className="flex justify-between mb-4 pt-2 border-t font-bold">
                <span>Total</span>
                <span>LKR {(cartTotal + cartTotal * 0.01).toFixed(2)}</span>
              </div>
              <Link href="/checkout">
