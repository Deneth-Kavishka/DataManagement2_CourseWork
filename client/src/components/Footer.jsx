    ...
    <footer className="bg-neutral-900 text-white pt-12 pb-6">
      <div className="max-w-7xl mx-auto px-4">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-neutral-400">123 Urban Ave, New York, NY 10001</span>
              </li>
              <li className="flex items-start">
        ...
        <div className="border-t border-neutral-800 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-neutral-500 text-sm mb-4 md:mb-0">© 2023 UrbanFood. All rights reserved.</p>
